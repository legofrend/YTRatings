...
13. добавить фильтрация и поиск по каналам, потом по видео
14. ~~поменять футр, контакт для связи~~ (`o2t4.ru@mail.ru`, без Google Form)
15. ~~проверить 404, сделать ссылку на правильный путь~~ (soft-404 + селект категории)
